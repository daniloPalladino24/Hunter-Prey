...
PATH = "Progetto Palladino Danilo-Dedi Vittorio/fonts/"

def get_player_names():
    title_font = pygame.font.Font(PATH + "Lobster-Regular.ttf", 60)
    input_font = pygame.font.Font(PATH + "Montserrat-Regular.ttf", 25)
    ...
    while typing:
        ...
        instructions = input_font.render("Press Enter when done", True, WHITE)
        WIN.blit(instructions, (WIN.get_width() // 2 - instructions.get_width() // 2, 250))
        pygame.display.flip()
...
def display_message(text, duration=2000):
    font = pygame.font.Font(PATH + "Lobster-Regular.ttf", 70)
...
def draw_scores(name1, score1, timer, name2, score2):
    font = pygame.font.Font(PATH + "Lobster-Regular.ttf", 30)
